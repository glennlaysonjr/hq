<script>
//Code Editor Built By @justcaliturner
// packege name: vue-code-editor
// Bugs and couldnt load in nuxt3 so i had to make a few changes
import hljs from "highlight.js";
import Dropdown from "./Dropdown.vue";
import CopyCode from "./CopyCode.vue";
import "@/assets/css/themes-base16.css";
